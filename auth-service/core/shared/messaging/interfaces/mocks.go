...
func (_mock *MockProducer) Produce(message []byte) error {
...
//   - message []byte
func (_e *MockProducer_Expecter) Produce(message any) *MockProducer_Produce_Call {
	return &MockProducer_Produce_Call{Call: _e.mock.On("Produce", message)}
}

func (_c *MockProducer_Produce_Call) Run(run func(message []byte)) *MockProducer_Produce_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 []byte
		if args[0] != nil {
			arg0 = args[0].([]byte)
...
func (_c *MockProducer_Produce_Call) RunAndReturn(run func(message []byte) error) *MockProducer_Produce_Call {
	_c.Call.Return(run)
	return _c
}
