...
type DesignerProfileRepository interface {
	...
	UpdateDesignerProfile(ctx context.Context, profile domains.DesignerProfile) (domains.DesignerProfile, error)
	AddDesignerProfile(ctx context.Context, profile domains.DesignerProfile) (domains.DesignerProfile, error)
}
